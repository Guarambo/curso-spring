...
public class ClienteController {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model m) {
		...
		// m.addAttribute("clients", clienteService.findAll());			listar todos los clientes
	...
	public String guardar(@Valid Cliente cl, BindingResult result, Model m, RedirectAttributes flash,
			SessionStatus stat) {
